...
template <
    ::xrn::ecs::detail::constraint::isComponent ComponentType
> [[ nodiscard ]] auto ::xrn::ecs::entity::Reference::getComponent() const
    -> const ::std::remove_cvref_t<::std::remove_pointer_t<ComponentType>>*
{
    return m_components->get<ComponentType>(*m_entity);
}

///////////////////////////////////////////////////////////////////////////
template <
    ::xrn::ecs::detail::constraint::isComponent ComponentType
> [[ nodiscard ]] auto ::xrn::ecs::entity::Reference::getComponent()
