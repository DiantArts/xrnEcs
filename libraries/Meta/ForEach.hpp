...
///
/// ::xrn::meta::ForEach structure's purpuse is to execute different actions
/// on a variadic list of type given as template parameters argment to the class
///
/// The user can then decide to execute funtions or comparisons for each of them
///
